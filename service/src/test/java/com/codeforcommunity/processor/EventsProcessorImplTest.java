...
//    assertEquals(res.getThumbnail(), BUCKET_PUBLIC_URL + "/" + DIR_NAME +
// "/sample_thumbnail.gif");
...
// myJooqMock.getSqlOperationBindings().get(OperationType.UPDATE).get(0);
//
//    assertEquals(9, updateBindings.length);
//    // TODO: create a method assertBindingsEqual() to check if the bindings are equal without
// caring
//    // about order
...
//    myEventsProcessorImpl.modifyEvent(0, req, myUserData);
//
//    List<Object[]> updateBindings =
// myJooqMock.getSqlOperationBindings().get(OperationType.UPDATE);
//
...
//
//    Object[] deleteBindings =
// myJooqMock.getSqlOperationBindings().get(OperationType.DELETE).get(0);
//
...
//    Result<
//            Record9<
//                String, String, String, Integer, Integer, PrivilegeLevel, String, String,
// Boolean>>
//        result =
//            myJooqMock
//                .getContext()
